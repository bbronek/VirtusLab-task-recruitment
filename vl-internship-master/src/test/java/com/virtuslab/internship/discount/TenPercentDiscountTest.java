...
class TenPercentDiscountTest {
    ...
    @Test
    void shouldApply10PercentDiscountWhenPriceIsAbove50AfterGrainDiscount() {
        // Given
        var productDb = new ProductDb();
        var cheese = productDb.getProduct("Cheese");
        var steak = productDb.getProduct("Steak");
        ...
        var expectedTotalPrice = cheese.price().add(steak.price()).add(cereals.price().multiply(BigDecimal.valueOf(9))).multiply(BigDecimal.valueOf(0.765));
